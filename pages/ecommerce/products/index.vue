      ...
      <div class="col-12">
        <div class="card">
          <div class="card-body">
            <div class="row mb-2">
              <div class="col-sm-6">
                <nuxt-link to="/ecommerce/products/product-create" class="btn btn-danger mb-2"><i
                ...
                <template v-slot:cell(action)>
                  <ul class="list-inline table-action m-0">
                    <li class="list-inline-item">
                      <NuxtLink to="/ecommerce/products/1/view" class="action-icon"><i class="mdi mdi-eye"></i>
                      </NuxtLink>
                    </li>
                    <li class="list-inline-item">
                      <NuxtLink to="/ecommerce/products/1/edit" class="action-icon"><i
                        class="mdi mdi-square-edit-outline"></i></NuxtLink>
                    </li>
                    <li class="list-inline-item">
